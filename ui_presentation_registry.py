...
SCREENS: dict[str, ScreenDef] = {
    ...
    "tariffs.home": ScreenDef("tariffs.home", "customer", "sales", "تعرفه‌ها", 4),
    ...
    "support.mine": ScreenDef("support.mine", "customer", "support", "تیکت‌های من", 1),
    "support.ticket": ScreenDef("support.ticket", "customer", "support", "جزئیات تیکت", 2),
    "support.close": ScreenDef("support.close", "customer", "support", "تأیید بستن تیکت", 3),
...
BUTTONS: tuple[ButtonDef, ...] = (
    ...
    ButtonDef("home.shared.tariffs", "home.shared", "تعرفه‌ها", "tariffs:home", rank=0),
    ButtonDef("home.shared.trial", "home.shared", "تست رایگان", "svcmarket:trial", rank=1),
    ButtonDef("home.shared.support", "home.shared", "پشتیبانی", "support:home", rank=2),
    ...
    ButtonDef("support.home.mine", "support.home", "تیکت‌های من", "support:mine", rank=1),
    ButtonDef("support.home.back", "support.home", "بازگشت", "public_back_main", rank=90, navigation_type="back"),
    ButtonDef("support.mine.open", "support.mine", "تیکت‌های باز", "support:mine:open:0", rank=0),
    ButtonDef("support.mine.closed", "support.mine", "تیکت‌های بسته", "support:mine:closed:0", rank=1),
    ButtonDef("support.mine.back", "support.mine", "بازگشت", "support:home", "بازگشت", 90, navigation_type="back"),
...
_DYNAMIC_PREFIX_REASONS: tuple[tuple[str, str], ...] = (
    ...
    ("support:ticket:", "تیکت کاربر پویا"),
    ("support:closeask:", "عملیات روی تیکت پویا"),
    ("support:closeconfirm:", "عملیات روی تیکت پویا"),
    ("support:mine:open:", "صفحه‌بندی تیکت‌های باز"),
    ("support:mine:closed:", "صفحه‌بندی تیکت‌های بسته"),
    ("cc:ticket:", "تیکت مدیریت پویا"),
    ("cc:ticketclose:", "عملیات روی تیکت پویا"),
    ("cc:ticketcloseconfirm:", "عملیات روی تیکت پویا"),
    ("cc:user:", "کاربر پویا"),
    ("cc:order:", "سفارش پویا"),
